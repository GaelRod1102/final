...
class _SecondPageState extends State<SecondPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Solicitud de Licencia'),
            ...
            children: <Widget>[
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(image: NetworkImage('https://raw.githubusercontent.com/GaelRod1102/licencias/main/licencia.jpg'), alignment: Alignment.topCenter),
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    new DropdownButton<String>(
                      ...
                      hint: Text('Sucursal donde lo hara'),
                      value: _value,
                    ), //fin de dropdown
                  ], //fin de widget
                ), //fin de row
